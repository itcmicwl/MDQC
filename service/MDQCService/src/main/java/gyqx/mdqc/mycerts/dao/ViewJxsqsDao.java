...
public class ViewJxsqsDao {
    ...
    public List<GoodsCertInfoVo> listGoodsInfoByHosId(String corpId, String hosId) {
//        return mapper.listProvGoodsInfo(null, null, corpId, hosId);
        return mapper.listProvGoodsCertInfo(corpId, hosId);
    }

    public List<CertInfoVo> getAllCertInfo(String goodsId, String corpId, List<String> chiefIds) {
        return mapper.listAllCertInfo(goodsId, corpId, chiefIds);
    }
}
