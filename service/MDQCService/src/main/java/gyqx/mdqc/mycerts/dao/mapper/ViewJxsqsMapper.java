...
public interface ViewJxsqsMapper {
    ...
    List<CertInfoVo> listAllCertInfo(@Param("goodsId") String goodsId,
                                     @Param("corpId") String corpId,
                                     @Param("chiefIds") List<String> chiefIds);

    List<GoodsCertInfoVo> listProvGoodsCertInfo(@Param("provId") String provId,
                                                @Param("hosId") String hosId);
}
