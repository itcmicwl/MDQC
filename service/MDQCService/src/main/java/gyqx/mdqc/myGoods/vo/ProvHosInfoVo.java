...
public class ProvHosInfoVo {
	...
	public String toString() {
		return "ProvHosInfoVo [id=" + id + ", provId=" + provId + ", provName=" + provName + ", hosId=" + hosId
				+ ", hosName=" + hosName + ", hosLxr=" + hosLxr + ", hosLxrTelphonenum=" + hosLxrTelphonenum
				+ ", provLxr=" + provLxr + ", provLxrTelphonenum=" + provLxrTelphonenum + ", status=" + status
				+ ", remark=" + remark + ", uid=" + uid + ", fillDate=" + fillDate + ", lastUpdateDatetime="
