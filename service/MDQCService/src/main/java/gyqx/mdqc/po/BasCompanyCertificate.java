 ...
 * 公司证件信息
*/
@Table(name="bas_company_certificate")
public class BasCompanyCertificate implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "BasCompanyCertificate [" +" id=" +  id   +", companyId=" +  companyId   +", certKind=" +  certKind   +", certCode=" +  certCode   +", expdtBeginDate=" +  expdtBeginDate   +", expdtEndDate=" +  expdtEndDate   +", isValiding=" +  isValiding   +", uxid=" +  uxid   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
