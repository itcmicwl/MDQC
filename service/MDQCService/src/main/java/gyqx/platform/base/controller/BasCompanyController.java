...
public class BasCompanyController extends BaseController {
	...
	@RequestMapping(value = "importCompanyCertInfos")
	...
	@ResponseBody
	public AjaxResult insert(@RequestBody @Valid BasCompanyInfo company,
							 @RequestParam(value = "addToProv", defaultValue = "false") boolean addToProv,
                             @RequestParam(value = "isProv", defaultValue = "false") boolean isProv,
                             Errors error) throws Exception {
		AjaxResult result = new AjaxResult();
		filterErrors(error);
		company.setFlag("1");
		company= basCompanyService.addBasCompany(company, addToProv, isProv);
	...
	@ResponseBody
	public AjaxResult openCompany(@RequestBody @Valid BasCompanyInfo company, Errors error) throws Exception {
		AjaxResult result = new AjaxResult();
		filterErrors(error);
		basCompanyService.openCompany(company);
		return result;
	}
