...
public interface IBasCompanyService {
	...
	public void openCompany(BasCompanyInfo company) throws Exception;

    BasCompanyInfo addBasCompany(BasCompanyInfo company, boolean addMyProv, boolean isProv) throws Exception;
}
