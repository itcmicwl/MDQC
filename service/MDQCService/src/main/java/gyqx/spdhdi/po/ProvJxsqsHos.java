 ...
 * 经销授权书适用医院
*/
@Table(name="prov_jxsqs_hos")
public class ProvJxsqsHos implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "ProvJxsqsHos [" +" id=" +  id   +", sqsId=" +  sqsId   +", provId=" +  provId   +", hosId=" +  hosId   +", uxid=" +  uxid   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
