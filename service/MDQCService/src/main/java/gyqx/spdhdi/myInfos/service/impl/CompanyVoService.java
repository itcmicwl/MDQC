...
public class CompanyVoService implements ICompanyVoService {
	...
	public List<CompanyCertificateVo> getCertificatelistByIds(List companyIdList) throws Exception{
		return companyInfoVoDao.getCertificatelistByIds(companyIdList);
	}
	...
	@Override
	public void updateProvCerts(CompanyCertificateVo certVo) throws Exception {
