...
public class ProvMfrsInfoServiceImpl implements ProvMfrsInfoService {
    ...
    @Override
    public List<BasMfrsInfoMyCertsVo> findBasMfrs(String mfrsName, String provId, int pageNum, int pageSize) {
        mfrsName = mfrsName.replaceAll("%", "\\\\%");
        return provMfrsInfoDao.getBasMfrs(mfrsName, provId, pageNum, pageSize);
    }
