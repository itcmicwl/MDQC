<template>
  <div id="hosEdit" style="height: 100%;overflow:auto;">
                    ...
                    <el-row>
                      <a :href='imgBasePath+scope.row.basCompanyCertificateImages[i-1].filePath'
                        ...
                        <el-tag type="danger" color="#ccb100" size="small" v-if="scope.row.certKind=='1'"
                                style="color: white;font-weight: bold" class="box_shadow_class">营业执照</el-tag>
                        <el-tag type="success" color="#e96146" size="small" class="box_shadow_class"
                                style="font-weight: bold;color: white" v-else>执业许可</el-tag>
                      </a>
                    </el-row>
                  </el-col>
                </template>
...
<script>
  ...
  export default {
    ...
    methods: {
      cancel:function () {
        this.$router.push({ path: 'hosInfo',query:{companyName:this.companyName}});
      },
