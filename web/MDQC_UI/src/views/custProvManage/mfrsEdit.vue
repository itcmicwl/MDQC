<template>
  <div id="mfrsEdit"
            ...
            <el-form :model="company"
              ...
              <el-row>
                <el-col :span="16">
                  <el-form-item label="企业名称"
                                :error="errors.codeErr">
                    <el-input v-model="company.cname"
                              :readonly="editDisable"
                              style="border: 0px;"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="法人代表"
                                prop="legal"
                                :error="errors.codeErr">
                    <el-input v-model="company.legal"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item label="我是供应商"
                                :error="errors.codeErr">
                    <el-checkbox v-model="ifMfrs"
                                 @change="changeIfMfrs"></el-checkbox>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="厂家类型"
                                ...
                                :error="errors.codeErr">
                    <template>
                      <el-radio-group v-model="company.mfrsKind"
                                      size="mini">
                        <el-radio label="1"
                                  border>境内</el-radio>
                        <el-radio label="2"
                ...
                <el-col :span="8">
                  <el-form-item label="联系人"
                                prop="linkman"
                                :error="errors.codeErr">
                    <el-input v-model="company.linkman"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="联系方式"
                                prop="contactWay"
                                :error="errors.codeErr">
                    <el-input v-model="company.contactWay"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="邮政编码"
                                prop="postCode"
                                :error="errors.codeErr">
                    <el-input v-model="company.postCode"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="传真"
                                prop="contactFax"
                                :error="errors.codeErr">
                    <el-input v-model="company.contactFax"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="经营许可证"
                                prop="jyxkCode"
                                :error="errors.codeErr">
                    <el-input v-model="company.jyxkCode"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="营业执照"
                                prop="regCode"
                                :error="errors.codeErr">
                    <el-input v-model="company.regCode"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="内部erp编码"
                                prop="erpCode"
                                :error="errors.codeErr">
                    <el-input v-model="company.erpCode"
                              :readonly="editDisable"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-col :span="16">
                <el-form-item label="备注信息"
                              prop="remark">
                  <el-input :readonly="editDisable"
                            v-model="company.remark"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="主数据编码"
                              prop="masterCode"
                              :error="errors.codeErr">
                  <el-input v-model="company.masterCode"
                            :readonly="editDisable"></el-input>
                </el-form-item>
              </el-col>
            </el-form>
    ...
    <el-row style="max-width: 960px;margin:0 auto">
      <el-col :span="24">
        <el-button type="text"
                   plain
                   @click="addProvCerts"
                   :disabled="!company.id">新增证照</el-button>
        <el-col>
          <el-table :data="company.companyCertificateVos"
                    highlight-current-row
                    style="width: 100%;"
                    border
                    fit>
            <el-table-column prop="certKind"
                             align="left"
                             width="180"
                             :formatter="formateCertType"
                             label="证照类型">
            </el-table-column>
            <el-table-column prop="certCode"
                             label="证照编码">
            </el-table-column>
            <el-table-column header-align="center"
              ...
              <template slot-scope="scope">
                ...
                <div style="color: #57b547"
                     v-if="scope.row.isValiding==='1'">
                    ...
                    <el-row>
                      <a :href="imgBasePath+scope.row.basCompanyCertificateImages[i-1].filePath"
                        ...
                        <el-tag type="danger"
                                color="#ccb100"
                                size="small"
                                v-if="scope.row.certKind=='1'"
                                style="color: white;font-weight: bold;"
                                class="box_shadow_class">营业执照
                        </el-tag>
                        <el-tag type="success"
                                color="#99cc11"
                                size="small"
                                v-if="scope.row.certKind=='3'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">税务登记
                        </el-tag>
                        <el-tag type="success"
                                color="#78be9c"
                                size="small"
                                v-if="scope.row.certKind=='4'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">机构代码
                        </el-tag>
                        <el-tag type="success"
                                color="#3e6ff2"
                                size="small"
                                v-if="scope.row.certKind=='5'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">经营许可
                        </el-tag>
                        <el-tag type="success"
                                color="#3369a4"
                                size="small"
                                v-if="scope.row.certKind=='6'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">经营备案
                        </el-tag>
                        <el-tag type="success"
                                color="#e63533"
                                size="small"
                                v-if="scope.row.certKind=='7'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">生产许可
                        </el-tag>
                        <el-tag type="success"
                                color="#b72655"
                                size="small"
                                v-if="scope.row.certKind=='8'"
                                style="font-weight: bold;color: white"
                                class="box_shadow_class">生产备案
                        </el-tag>
                      </a>
                    </el-row>
                  </el-col>
            ...
            <el-table-column label="操作"
                             ...
                             align="center">
              <template slot-scope="scope">
                <el-button @click="updateProvCerts(scope.row)"
                           type="text">编辑</el-button>
                <el-button @click="deleteProvCerts(scope.row)"
                           style="color: #f56c6c;"
    ...
    <el-dialog title="添加证照信息"
      ...
      <el-form :model="companyCerts"
        ...
        <el-form-item label="证照类型"
                      prop="certKind">
          <el-select v-model="companyCerts.certKind"
                     placeholder="请选择"
                     clearable
                     @change="provCertSelect">
            <el-option v-for="item in certKinds"
                       :key="item.val"
                       :label="item.ename"
                       :value="item.val">
            </el-option>
        ...
        <el-form-item label="证照编码"
                      prop="certCode">
          <el-input v-model="companyCerts.certCode"
                    style="width: 97.5%;"></el-input>
        </el-form-item>
        <el-form-item label="证照有效期">
          <el-col :span="6">
            <el-form-item prop="expdtBeginDate">
              <el-date-picker type="date"
                              placeholder="开始日期"
                              v-model="companyCerts.expdtBeginDate"
          ...
          <el-col :span="6">
            <el-form-item prop="expdtEndDate">
              <el-date-picker type="date"
                              placeholder="结束日期"
                              v-model="companyCerts.expdtEndDate"
                              style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-form-item>
        <el-form-item label="是否长期有效">
          <el-radio-group v-model="companyCerts.isValiding"
                          @change="isValidingSelect"
                          size="mini">
      ...
      <div class="uploadCertClass">
        <el-upload ref="provCertsUpload"
          ...
          <div slot="tip"
               class="el-upload__tip">注：只能上传jpg/png/bmp/pdf文件，且不超过15MB</div>
        </el-upload>
      </div>
      <span slot="footer"
            class="dialog-footer">
    ...
    <el-dialog title="修改证照信息"
               :visible.sync="updateCertVisible">
      <el-form :model="companyCerts"
               ref="updateCertsForm"
               label-width="100px"
               class="el-form-item-nomsg">
      ...
      <div class="uploadCertClass">
        <el-upload accept=".bmp,.jpg,.png,.pdf"
                   :headers="userInfo"
                   :multiple="true"
                   :action="uploadCompanyCertsUrl"
                   :file-list="fileList"
...
export default {
  data() {
    ...
    let validateEndDate = (rule, value, callback) => {
      if (!value) {
        ...
        if (
          Date.parse(this.companyCerts.expdtBeginDate) >
          Date.parse(this.companyCerts.expdtEndDate)
        ) {
  ...
  mounted() {
    ...
    if (tempObj.companyId) {
      this.corpId = tempObj.companyId;
      this.companyName = tempObj.companyName;
      this.getCompanyInfo(this.corpId);
    }
    if (tempObj.editDisable) {
      this.editDisable = false;
    }
    if (tempObj.addMyMfrs) {
      this.addMyMfrs = tempObj.addMyMfrs;
    }
  ...
  methods: {
    ...
    changeIfMfrs: function(d1, d2, d3) {
      if (d1) {
        // 勾选我是供应商，则机构类型为'4-厂供一体'
        this.company.kind = "4";
      } else {
        // 取消勾选我是供应商，则机构类型为'3-厂商'
        this.company.kind = "3";
      }
    },
    cancel: function() {
      this.$router.push({
        path: "mfrsInfo",
        query: { companyName: this.companyName }
      });
    },
    ...
    updateCerts() {
      ...
      let serverUrl = "/mdqcService/myInfo/companyInfo/updateProvCerts";
      this.companyCerts.companyId = this.corpId;
      this.axios
        .post(serverUrl, this.companyCerts)
        .then(res => {
          if (res.data.code >= 0) {
            ...
            this.$message.error(
              "操作失败，" + res.data.msg.substring(0, 50) + "..."
            );
          }
          this.getCompanyInfo(this.corpId);
        })
    ...
    handleProvCertsSuccess(response, file, fileList) {
      ...
      this.companyCerts.basCompanyCertificateImages.push({
        fileName: name,
        filePath: certPath
      });
      if (this.fileUploadCount == fileList.length) {
        // 待所有附件上传完成了再一起保存
        this.dlgConfirm();
      }
    },
    ...
    addImage(imageObj) {
      let serverUrl = "/mdqcService/myInfo/companyInfo/addImage";
      this.axios
        .post(serverUrl, imageObj)
        .then(res => {
          if (res.data.code >= 0) {
            this.$message.success("操作成功。");
          } else {
    ...
    deleteProvCerts: function(row) {
      this.$confirm("确认删除吗?", "提示", {})
        .then(() => {
          this.axios
            .post("/mdqcService/myInfo/companyInfo/deleteProvCerts", row)
            .then(
              res => {
                if (res.data.code == "0") {
                  this.getCompanyInfo(this.corpId);
    ...
    deleteCert: function(file, fileList) {
      ...
      this.axios
        .post("/mdqcService/myInfo/companyInfo/deleteImage", { id: file.id })
        .then(
          res => {
            if (res.data.code == "0") {
              this.getCompanyInfo(this.corpId);
    ...
    dlgConfirm() {
      this.$refs.cnsForm.validate(valid => {
        if (valid) {
          this.dlgConfirmBtnLoading = true;
          let serverUrl = "/mdqcService/myInfo/companyInfo/addProvCerts";
          this.companyCerts.companyId = this.corpId;
          this.axios
            .post(serverUrl, this.companyCerts)
            .then(res => {
    ...
    getCompanyInfo: function(corpId) {
      ...
      var _this = this;
      this.axios
        .post("/mdqcService/myInfo/companyInfo/getCompanyInfo", corpId)
        .then(
          res => {
            this.loading = false;
            if (res.data.code == "0") {
              this.company = res.data.data;
              this.ifMfrs = res.data.data.kind == "4" ? true : false;
              this.getZZLX();
    ...
    saveCompanyInfo: function() {
      ...
      let serviceUrl = "/mdqcService/bas/company/insert";
      if (this.addMyMfrs) {
        serviceUrl = serviceUrl + "?addToProv=" + this.addMyMfrs;
      }
      if (this.company.id) {
        serviceUrl = "/mdqcService/myInfo/companyInfo/updateCompanyCertificate";
      }
      this.axios.post(serviceUrl, this.company).then(
        res => {
        ...
        .then(
          res => {
            ...
            if (res.data.code == "0") {
              ...
              let tempArray = [];
              if (this.company.kind == "3") {
                // 如果机构类型是'3-厂商'，则取厂商证照类型字典
