    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" label-width="88px" class="queryFormClass">
        <el-form-item label="供应商名称">
          <el-input v-model="filters.cname" style="height: 28px;" placeholder="输入供应商名称" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="success" icon="el-icon-plus" plain style="height: 28px" @click="provAdd(null)" >新增供应商</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    <!--列表-->
  ...
  export default {
    ...
    methods: {
      provEdit:function (row) {
          this.$router.push({ path: 'provEdit', query: {companyId: row.id,editDisable: '1',companyName:this.filters.cname}});
      },
      provAdd:function () {
          this.$router.push({ path: 'provEdit', query: {editDisable: '1'}});
      },
      flagChange:function () {
      ...
      getProvInfoList: function (pIndex) {
        ...
        var param = {
          orderBy: "",
          queryObject: {cname: this.filters.cname,flag:this.filters.flag,kind: 2},
          page: this.page,
          rows: this.pageSize
        };
        this.loading = true;
...
<style>
  ...
  #dealer .el-radio-button__orig-radio:checked+.el-radio-button__inner{
    color: #ffffff;
    background: #535c63;
    border-color: #676082;
  }
  ...
  #dealer .el-radio-button:first-child .el-radio-button__inner {
    border-left: 1px solid #dcdfe6;
    border-radius: 4px 0 0 4px;
    -webkit-box-shadow: none!important;
    box-shadow: none!important;
  }
  #dealer .el-radio-button:last-child .el-radio-button__inner {
    border-radius: 0px 4px 4px 0px;
    -webkit-box-shadow: none!important;
    box-shadow: none!important;
  }
  #dealer .el-input--mini .el-input__inner{
    height: 28px;
  }
  .queryFormClass{
    padding-top: 3px;
  ...
  #dealer .el-form--inline .el-form-item {
     margin-right: 0px;
  }
  #dealer .toolbar {
    margin-bottom: 1px;
