<template>
  <div id="hos" style="height: 100%;">
    <!--工具条-->
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" label-width="88px" class="queryFormClass">
        <el-form-item label="医院名称">
          <el-input v-model="filters.cname" style="height: 28px;" placeholder="输入医院名称" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="success" icon="el-icon-plus" plain style="height: 28px" @click="provAdd(null)" >新增医院</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    <!--列表-->
    <template>
      <el-table :data="provs" highlight-current-row v-loading="loading" border style="width: 100%;" fit
                class="hos-tableheight" height="outer">
        <el-table-column type="index" label="序号" width="50" align="center">
        </el-table-column>
        <el-table-column prop="cname" label="医院名称">
        </el-table-column>
        ...
        <el-table-column label="操作" width="150" align="center">
          <template slot-scope="scope">
            <el-button-group>
              <el-button type="primary" size="mini" @click="hosEdit(scope.row)"  icon="el-icon-edit-outline">编辑信息</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      hosEdit:function (row) {
        this.$router.push({ path: 'hosEdit', query: {companyId: row.id,editDisable: '1',companyName:this.filters.cname}});
      },
      provAdd:function () {
        this.$router.push({ path: 'hosEdit', query: {editDisable: '1'}});
      },
      flagChange:function () {
      ...
      getProvInfoList: function (pIndex) {
        ...
        var param = {
          orderBy: "",
          queryObject: {cname: this.filters.cname,flag:this.filters.flag,kind: 1},
          page: this.page,
          rows: this.pageSize
        };
        this.loading = true;
...
<style>
  ...
  #hos .el-radio-button__orig-radio:checked+.el-radio-button__inner{
    color: #ffffff;
    background: #535c63;
    border-color: #676082;
  }
  #hos .el-radio-button--mini .el-radio-button__inner {
    height: 28px;
    width: 38px;
    padding: 7px 7px 6px;
    font-size: 12px;
  ...
  #hos .el-radio-button:first-child .el-radio-button__inner {
    border-left: 1px solid #dcdfe6;
    border-radius: 4px 0 0 4px;
    -webkit-box-shadow: none!important;
    box-shadow: none!important;
  }
  #hos .el-radio-button:last-child .el-radio-button__inner {
    border-radius: 0px 4px 4px 0px;
    -webkit-box-shadow: none!important;
    box-shadow: none!important;
  }
  #hos .el-input--mini .el-input__inner{
    height: 28px;
  }
  .queryFormClass{
    padding-top: 3px;
  ...
  #hos .el-form--inline .el-form-item {
    margin-right: 0px;
  }
  #hos .toolbar {
    margin-bottom: 1px;
