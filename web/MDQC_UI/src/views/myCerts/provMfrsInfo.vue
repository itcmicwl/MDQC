<template>
    <div id="provMfrsInfo" style="height:100%;overflow-y: auto;">
        <transition name="el-fade-in-linear">
            <div v-show="bShowMfrsListForm" style="height: 100%;">
                ...
                <el-table highlight-current-row class="provMfrsInfo-tableheight" ref="mfrsTable" :data="mfrsList"
                    ...
                    <el-table-column prop="mfrsInfo.cname" label="厂家名称" show-overflow-tooltip  header-align="center">
                    </el-table-column>
      ...
      <el-dialog :title="provMfrsCertsTitle" close="onClose" :visible.sync="provMfrsCertsVisible" :show-close='true'
                 :close-on-press-escape='true' :close-on-click-modal="true" width="70%" :loading="queryProvMfrsCertsloading">
        <el-table :data="provMfrsCerts" highlight-current-row  style="width: 100%;" border fit height="250">
          ...
          <el-table-column prop="isValiding" label="是否长期有效">
            <template slot-scope="scope">
            <div v-if="scope.row.isValiding ==0">否</div>
            <div v-else>是</div>
            </template>
          </el-table-column>
        ...
        <transition name="el-fade-in-linear">
            <div v-show="!bShowMfrsListForm" style="height: 100%;">
                <!-- <el-dialog title="厂家信息" :visible.sync="dlgVisible" width="70%"> -->
                    <div style="margin-bottom:7px;" class="text-align-center">
                        <el-autocomplete :trigger-on-focus="false" :visible.sync="dlgMfrsName"
                            ...
                            @select="handleDlgMfrsSelect" value-key="cname">
                        </el-autocomplete>
                    </div>
                    <el-form :model="currentMfrs" ref="mfrsForm" label-width="100px" class="el-form-item-nomsg">
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="厂家名称" prop="cname">
                                    <el-input v-model="currentMfrs.mfrsInfo.cname" disabled ></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
    ...
    export default {
        data() {
            return {
              ...
              bShowMfrsListForm: true,
              bShowAddForm: false,

              baseURL: '/mdqcService/provMfrsInfo',
        ...
        methods: {
          ...
          getProvMfrsCerts(item) {
            this.provMfrsCertsTitle = '【'+ item.mfrsInfo.cname+'】' + '企业资质';
