<template>
    <div id="provFrwts" style="height:100%;">
        ...
        <el-table highlight-current-row  class="provFrwts-tableheight" ref="frwtsTable" :row-class-name="tableRowClassName"
          ...
          <el-table-column label="委托书编号" prop="id" width="120">
          </el-table-column>
          <el-table-column label="委托单位" show-overflow-tooltip prop="provName">
          </el-table-column>
          <el-table-column label="被委托单位" show-overflow-tooltip prop="hosName">
          </el-table-column>
