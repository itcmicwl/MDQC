    ...
    methods: {
        ...
        sltHosChange(hosInfo){
            ...
            if(this.hosList.filter(o=>o.id == hosInfo.id).length==0){
                ...
                this.axios.post(`/mdqcService/provJxsqs/saveSqsHosLst/`,param).then(res=>{
                    if(res.data.code == 0){
        ...
        searchHostLst(sqsId){    
            var _this = this;        
            this.axios.get(`/mdqcService/provJxsqs/getSqsHosLst/${sqsId}`).then(res=>{
                if(res.data.code == 0){
                    _this.hosList = res.data.data;
                }
            },err=>{});
        ...
        delHos(row){
            ...
            this.axios.post('/mdqcService/provJxsqs/delSqsHos',param).then(res=>{
                if(res.data.code==0){
                    _this.hosList = res.data.data;
                    _this.hosLoading = false;
