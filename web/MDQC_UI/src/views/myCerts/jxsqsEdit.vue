  ...
  export default {
    ...
    methods: {
      ...
      getJxsqsGoodsInfo: function (hIndex) {
        ...
        this.loading = true;
        this.axios.post('/mdqcService/myCerts/jxsqs/getJxsqsGoodsInfo', param).then(res => {
          this.loading = false;
          if (res.data.code == "0") {
      ...
      getGoodsList: function (pIndex) {
        ...
        this.loading = true;
        this.axios.post('/mdqcService/bas/goods/getGoodsInfos', param).then(res => {
          this.loading = false;
          if (res.data.code == "0") {
      ...
      deleteJxsqsCert:function (file, fileList) {
        ...
        this.axios.post('/mdqcService/myCerts/jxsqs/deleteJxsqsCert', {id:file.id,filePath:file.url}).then(res => {
          if (res.data.code == "0") {
      ...
      updateJxsqsCert:function () {
        ...
        this.axios.post('/mdqcService/myCerts/jxsqs/updateJxsqsCert', param).then(res => {
          if (res.data.code == "0") {
            this.$message({message: '操作成功！', type: 'success'});
          }else{
            this.$message.error(res.data.msg);
      ...
      deleteJxsqsToHos:function (row) {
        ...
        delete row.cname;
        this.axios.post('/mdqcService/myCerts/jxsqs/deleteJxsqsToHos', row).then(res => {
          if (res.data.code == "0") {
            this.$message({message: '操作成功！', type: 'success'});
          }else{
            this.$message.error(res.data.msg);
      ...
      getJxsqsById:function (id) {
        this.axios.post('/mdqcService/myCerts/jxsqs/getForHospitals', id).then(res => {
          this.loading = false;
          if (res.data.code == "0") {
      ...
      deleteJxsqsGoods:function (row) {
        this.axios.post('/mdqcService/myCerts/jxsqs/deleteJxsqsGoods', {id:row.pjgId}).then(res => {
          if (res.data.code == "0") {
            this.$message({message: '操作成功！', type: 'success'});
      ...
      addJxsqsToHos:function (hosInfos) {
        ...
        this.axios.post('/mdqcService/myCerts/jxsqs/addJxsqsToHos/'+sqsId+'/'+provId, hosInfos).then(res => {
          if (res.data.code == "0") {
            this.$message({message: '操作成功！', type: 'success'});
      ...
      addJxsqsGoods:function (goodsInfos) {
        ...
        this.axios.post('/mdqcService/myCerts/jxsqs/addJxsqsGoods', tempJxsqsVo).then(res => {
          if (res.data.code == "0") {
            this.$message({message: '操作成功！', type: 'success'});
            this.getJxsqsGoodsInfo(1);
          }else{
      ...
      queryChiefAsync: function (queryString) {
        ...
        this.loading = true;
        this.axios.post('/mdqcService/custProvManage/provInfo/getProvInfo', param).then(res => {
          this.loading = false;
          if (res.data.code == "0") {
      ...
      addJxsqs:function () {
        let serviceUrl = "/mdqcService/myCerts/jxsqs/addJxsqs";
        let tempJxsqsVo = this.jxsqsVo;
      ...
      updateJxsqs:function () {
        ...
        let serviceUrl = "/mdqcService/myCerts/jxsqs/updateJxsqs";
